...
/* немного запутался в том, что сдать на проверку и том, что должно быть по вебпаку. Вебпак вроде хочет индекс.js в корневом каталоге, а тут по учебе
нужно в pages положить. Также для вебпака надо привязать стили через импорт CSS, но тогда при простой работе с файлом ничего не видно нормально.
тут стили оставил привязанными в html, надеюсь, это допустимо. А вот пути логотипов менять не стал. 
*/
